...
- Fossil pollen data
  - Access Neotoma
  - Download process only NA between 0-15 ka BP
  - harmonize to genus level
...
:::{.fragment}
Not so difficult with [VegVault]{.bold .text-pixel-font .text-color-white}!
:::
...
* 🔗 Website: [bit.ly/VegVault](https://bit.ly/vaultkeepr)
...
**S**cience **P**owered through **R**eproducibility, **O**penness, and **T**eamwork 
...
[Highly]{.bold .text-color-white} recomended for [all]{.bold .text-color-white} Geobotany students
